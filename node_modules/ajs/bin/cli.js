...
new Tilda(__dirname + "/../package.json", {
    ...
    examples: ["ajs template.ajs", "ajs -t template.ajs", "ajs -s template.ajs"]
}).main(function (app) {
    ...
    ajs._load(filename, {}, function (err, template) {
        ...
        if (app.options.tree.value) return console.log(util.inspect(template.toString(), false, 100) + "\n");else if (app.options.source.value) return console.log(template.toString() + "\n");
