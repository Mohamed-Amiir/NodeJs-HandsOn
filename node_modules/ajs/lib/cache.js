...
module.exports = new function () {
  ...
  this.get = function (filename, callback) {
    ...
    fs.stat(filename, function (err, stat) {
      ...
      if (cached.mtime.toString() != stat.mtime.toString()) callback(null, null);else callback(null, cached.template);
    });
  };
  ...
  this.getSync = function (filename) {
    ...
    if (cached.mtime.toString() != stat.mtime.toString()) return null;else return cached.template;
  };
